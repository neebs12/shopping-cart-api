...
process: 
  ...
  2) "allocated" and seatID availabilty
  ...
  3) "generalAdmission" and globalLimit
  ...
  4) !"generalAdmission" and seatId
    - if event.type !== "generalAdmission", then we need to check if the seatId is null
    - if seatId !== null, then throw error
